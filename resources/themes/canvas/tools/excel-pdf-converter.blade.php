            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    <div id="imageUploader" class="form-group">
                        <x-pdf-upload-wrapper max-files="2" :max-size="$tool->fs_tool" accept=".xls,.xlsx" input-name="files[]"
                            :file-title="__('tools.dropExcelDocumentHereTitle')" pages="false" rotate="false" preview="false" sortable="false" />
                    </div>
                </div>
            </div>
