            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    <div id="imageUploader" class="form-group">
                        <x-pdf-upload-wrapper :max-files="$tool->no_file_tool" :max-size="$tool->fs_tool" accept=".txt" input-name="files[]"
                            :file-title="__('tools.dropTextDocumentHereTitle')" pages="false" rotate="false" preview="false" sortable="false" />
                    </div>
                </div>
            </div>
