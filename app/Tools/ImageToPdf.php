...
class ImageToPdf implements ToolInterface
{
    ...
    {
        return view('tools.image-to-pdf', compact('tool'));
    }
    ...
    public function handle(Request $request, Tool $tool)
    {
        ...
        $request->validate([
            ...
            'files.*' => 'mimes:jpg,jpeg,png,gif,tiff,bmp',
            'margin' => 'required',
        ...
        $files = $request->input('files', false);
        ...
        return view('tools.image-to-pdf', compact('tool', 'results'));
    }
}
